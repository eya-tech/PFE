        ...
        <Grid alignItems="center" container spacing={3}>
          <Grid item xs={12} lg={7} md={6}>
            <TextField
              ...
              placeholder={t('Search firmwares by name ...')}
              value={query}
              fullWidth
              variant="outlined"
            />
      ...
      <Card>
          ...
          {!selectedBulkActions && (
            ...
            >
              <Box>
                ...
                <b>{paginatedInvoices.length}</b> <b>{t('firmwares')}</b>
              </Box>
              <TablePagination
                component="div"
        ...
        {paginatedInvoices.length === 0 ? (
          <Typography
            ...
            align="center"
          >
            {t("We couldn't find any firmwares matching your search criteria")}
          </Typography>
        ) : (
          <>
            <TableContainer>
                  ...
                  {paginatedInvoices.map((invoice) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          {/* {numeral(invoice.progress).format(
                            `${invoice.currency}0,0.00`
                          )}
                          {invoice.progress}{invoice.currency} */}
                          <Box
                              sx={{
                                minWidth: 175
                              }}
                            ...
                            >
                              <LinearProgress
                                ...
                                color={invoice.progress >= 50 ? "primary": "error" }
                                variant="determinate"
                              />
      ...
      >
        ...
        >
          ...
          <Typography
            ...
            variant="h3"
          >
            {t('Do you really want to delete this firmware')}?
          </Typography>
