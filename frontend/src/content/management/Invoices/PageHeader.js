...
function PageHeader() {
  ...
  const handleCreateInvoiceSuccess = () => {
    enqueueSnackbar(t('A new firmware has been created successfully'), {
      variant: 'success',
      anchorOrigin: {
        vertical: 'top',
        horizontal: 'right'
    ...
    <>
      <Grid container justifyContent="space-between" alignItems="center">
        <Grid item>
          ...
          <Typography variant="subtitle2">
            {t('All recent firmwares can be found below')}
          </Typography>
        </Grid>
        <Grid item>
          <Button
      ...
      >
        ...
        >
          ...
          <Typography variant="subtitle2">
            {t('Use this modal dialog to create a new firmware')}
          </Typography>
        </DialogTitle>
        <Formik
          initialValues={{
          ...
          validationSchema={Yup.object().shape({
            number: Yup.string()
              .max(255)
              .required(t('The firmware number field is required'))
          })}
          onSubmit={async (
            _values,
