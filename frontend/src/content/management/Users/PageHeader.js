      ...
      >
        ...
        <Formik
          ...
          onSubmit={async (
            ...
            try {
              // await wait(1000);
              _values.firstname = _values.first_name
              _values.lastname = _values.last_name
              _values.avatar = user.avatar
              // _values.role
              delete _values.first_name
              delete _values.last_name
             // console.log(_values)              
              ...
              if (res.data.success) {
                ...
                setUsers(users => [{_id,..._values},...users])
                      ...
                      <Grid item xs={12} md={6}>
                        <Autocomplete
                          ...
                          getOptionLabel={(option) => 
                           { 
                            if (option.label.toLowerCase() === "administrator") {
                              values.role._id = "6264b72ff7aaecf44b7a57e5"
                              values.role.titre = option.label.toLowerCase().substring(0, 5)
                            }else if(option.label.toLowerCase() === "user"){
                              values.role._id = "6264b764f7aaecf44b7a57e6"
                              values.role.titre = option.label.toLowerCase()

                            }
                            // console.log(option.label,values.role)
                            return option.label
